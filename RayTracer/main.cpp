...
void cornell_box() {
    ...
    shared_ptr<hittable> box1 = quad::box(point3(0, 0, 0), point3(165, 330, 165), white);
    box1 = make_shared<rotate_y>(box1, 15);
    box1 = make_shared<translate>(box1, vec3(265, 0, 295));
    world.add(box1);

    shared_ptr<hittable> box2 = quad::box(point3(0, 0, 0), point3(165, 165, 165), white);
...
void final_scene(int image_width, int samples_per_pixel, int max_depth) {
    ...
    cam.num_samples = samples_per_pixel;
    cam.max_depth = max_depth;
    cam.background = color(0, 0, 0);

    cam.vfov = 40;
    cam.camPos = point3(478, 278, -600);
    cam.lookat = point3(278, 278, 0);
    cam.up = vec3(0, 1, 0);
